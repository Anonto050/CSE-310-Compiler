...
executeIf : {
		  ...
		  $$ = new symbolInfo(labelIfFalse, "label");
...
/* executeElse : {
		  ...
		  $$ = new symbolInfo(labelElseEnd, "label");
...
statement : var_declaration{
	  ...
	  | FOR LPAREN expression_statement {
		...
		$<symbol_info>$ = new symbolInfo(startForLoopLabel, "label");
		...
		$<symbol_info>$ = new symbolInfo(endForLoopLabel, "label");
	  ...
	  { $<int_val>$ = asm_CS_endLine;
	  //cout << "asm_CS_endLine: " << asm_CS_endLine << endl;
	  }
	  expression {
		//write your code

		string expr = $8->getName();

		string str = "";
		string startForLoopLabel = $<symbol_info>4->getName();
		string endForLoopLabel = $<symbol_info>6->getName();
	   ...
	   | IF LPAREN expression RPAREN executeIf statement %prec ALTERNATIVE_ELSE{
		//write your code
	  ...
	  | IF LPAREN expression RPAREN executeIf statement ELSE {
		//write your code
		    
		  string labelElse = $5->getName();
		  string labelElseEnd = generateLabel();

		  $<symbol_info>$ = new symbolInfo(labelElseEnd, "label");
	  ...
	  | WHILE {
		...
		$<symbol_info>$ = new symbolInfo(startWhileLoopLabel, "label");
		...
		$<symbol_info>$ = new symbolInfo(endWhileLoopLabel, "label");

		str += "\tPOP AX\t; " + $4->getName() +" popped\n";
		str += "\tCMP AX, 0\n";
		...
		//write your code
			$$ = new symbolInfo("while("+ $4->getName()+")"+ $6->getName(), "variable");
		log_file<< "statement : WHILE LPAREN expression RPAREN statement " << endl;

		string str = "";
		string endWhileLoopLabel = $<symbol_info>5->getName();
		string startWhileLoopLabel = $<symbol_info>2->getName();
...
logic_expression : rel_expression{
		...
		if(logic_op == "&&"){
			...
			str += "\tPOP BX\t;"+$3->getName()+" popped\n";
			str += "\tPOP AX\t;"+$1->getName()+" popped\n";
			str += "\tCMP AX, 0\t;"+$1->getName()+"\n";
			str += "\tJNE "+leftTrueLabel+"\t;"+$1->getName()+" is true\n";
			str += "\tPUSH 0\t;"+$1->getName()+" is false\n";
			str += "\tJMP "+endLabel+"\t;"+$1->getName()+" is false\n";
			str += leftTrueLabel+":\n";
			str += "\tCMP BX, 0\t;"+$3->getName()+"\n";
			str += "\tJNE "+AllTrueLabel+"\t;"+$3->getName()+" is true\n";
			str += "\tPUSH 0\t;"+$3->getName()+" is false\n";
			str += "\tJMP "+endLabel+"\t;"+$3->getName()+" is false\n";
			str += AllTrueLabel+":\n";
			str += "\tPUSH 1\t;"+$1->getName()+" AND "+$3->getName()+" is true\n";
			str += endLabel+":\n";
			...
			str += "\tPOP AX\t;"+$1->getName()+" popped\n";
			str += "\tCMP AX, 0\t;"+$1->getName()+"\n";
			str += "\tJNE "+AllTrueLabel+"\t;"+$1->getName()+" is true\n";
			str += "\tCMP BX, 0\t;"+$3->getName()+"\n";
			str += "\tJNE "+AllTrueLabel+"\t;"+$3->getName()+" is true\n";
			str += "\tPUSH 0\t;"+$1->getName()+" OR "+$3->getName()+" is false\n";
			str += "\tJMP "+endLabel+"\t;"+$1->getName()+" OR "+$3->getName()+" is false\n";
			str += AllTrueLabel+":\n";
			str += "\tPUSH 1\t;"+$1->getName()+" OR "+$3->getName()+" is true\n";
			str += endLabel+":\n";
...
rel_expression	: simple_expression{
		...
		str += "\tPOP BX\t;"+$3->getName()+" popped\n";
		str += "\tPOP AX\t;"+$1->getName()+" popped\n";
		str += "\tCMP AX, BX\t;"+$1->getName()+" "+$2->getName()+" "+$3->getName()+"\n";
		str += "\t"+JumpConverter(relop)+" "+trueLabel+"\t;"+$1->getName()+" "+$2->getName()+" "+$3->getName()+"\n";
		str += "\tPUSH 0\t;"+$1->getName()+" "+$2->getName()+" "+$3->getName()+" is false\n";
		str += "\tJMP "+endLabel+"\t;"+$1->getName()+" "+$2->getName()+" "+$3->getName()+" is false\n";
		str += trueLabel+":\n";
		str += "\tPUSH 1\t;"+$1->getName()+" "+$2->getName()+" "+$3->getName()+" is true\n";
		str += endLabel+":\n";
...
unary_expression : ADDOP unary_expression{
		...
		if(addop_name == "-"){
			string str = "";
			str += "\tPOP AX\t; "+$2->getName()+" poped from stack\n";
			str += "\tNEG AX\n\tPUSH AX\t; -"+$2->getName()+" pushed to stack";
			writeCS(str);
		}
